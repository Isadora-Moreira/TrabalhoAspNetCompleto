...
public class DadosController : Controller
{
    ...
    public IActionResult Livros()
    {
        ...
        string[] titulos =
        {
            ...
            "Sapiens: Uma Breve História da Humanidade", "A Cor Púrpura", "O Fantasma da Ópera",
            "A Vida Secreta das Abelhas", "O Planeta dos Macacos", "O Anel do Nibelungo", "O Escaravelho do Diabo",
            "O Profeta", "O Diário de Zlata", "A Chave do Tamanho", "O Silmarillion", "A Guardiã de Memórias",
            "O Rei de Amarelo", "Contos de Horror do Século XIX", "O Grande Inquisidor", "O Hobbit",
            "Viagem ao Centro da Terra", "O Cemitério", "A Peste", "O Som do Trovão", "O Demônio do Meio-Dia",
            "Os Ratos", "O Cavaleiro Andante", "O Sumiço de Beatriz", "O Senhor das Moscas", "A Morte de Ivan Ilitch",
            "O Vilarejo", "A Queda de Gondolin", "O Mestre e Margarida", "O Tempo entre Costuras",
            "Cem Escovadas Antes de Dormir", "O Livro de Mórmon", "O Coração é um Caçador Solitário",
            "O Guardião do Tempo", "Eu Sou a Lenda", "O Andarilho das Sombras", "Cachorro Louco", "Estrela da Manhã",
            "Pássaros Feridos", "As Brumas de Avalon", "O Livro das Sombras", "A Ira dos Justos",
            "A Condessa Sangrenta", "O Desaparecido", "Quando Nietzsche Chorou", "O Pequeno Vampiro",
            "Uma Vida Pequena", "A Estranha Vida de Timothy Green", "O Último Templário",
            "A Assombração da Casa da Colina", "A Cor da Magia", "A Marcha do Folclore", "A Torre Negra",
            "Os Miseráveis", "Vidas em Jogo", "A Torre dos Anjos", "O Jogo do Anjo", "O Circo da Noite",
            "O Último Reino", "A Verdade Sobre o Caso Harry Quebert", "O Inverno do Mundo", "O Diário de Bridget Jones",
            "A Garota no Trem", "A Filha do Império", "Os Filhos de Húrin", "O Livro do Amanhã", "A Coisa",
            "Carrie, A Estranha", "Histórias Extraordinárias", "O Guia do Mochileiro das Galáxias",
            "Os Instrumentos Mortais", "A Amiga Genial", "Em Algum Lugar das Estrelas", "Os Contos de Beedle, o Bardo",
            "Amor nos Tempos do Cólera", "O Silêncio dos Inocentes", "O Terceiro Travesseiro", "O Encontro Marcado",
            "O Clã dos Magos", "A Espada do Destino", "O Apanhador de Sonhos", "A Rainha do Sul",
            "O Último dos Moicanos", "O Escudo da Águia", "A Grande Mentira", "A Menina que Amava Livros",
            "Os Cavaleiros de Cristal", "O Último Homem", "A Imperatriz dos Éteres", "O Homem que Calculava",
            "A Teoria de Tudo", "A Mão e a Luva", "O Lado Bom da Vida", "A Garota da Capa Vermelha", "A Escolha",
            "Coração Indomável", "A Morte e Vida de Charlie St. Cloud", "O Guardião", "Sob a Redoma",
            "A Canção de Aquiles", "O Perfume", "A Revolução dos Bichos", "A Arte da Felicidade", "A Jornada",
            "A Rainha das Sombras", "O Planeta Proibido", "O Príncipe", "A Outra Face",
            "A Irmandade das Calças Viajantes", "O Vendedor de Sonhos", "A Noite dos Mortos-Vivos",
            "Através do Espelho", "O Domínio do Lobo", "A Balada do Velho Marinheiro", "A Ilha do Tesouro",
            "O Herói Perdido", "Os Reis Malditos", "O Canto dos Pássaros", "O Jardim do Éden",
            "A Caçada ao Outubro Vermelho", "As Benevolentes", "O Livro das Criaturas Mágicas",
            "A Vida e a Morte de Brás Cubas", "O Vale dos Ossos", "A Moça Tecelã", "A Árvore Generosa",
            "O Corvo e Outras Poesias", "O Grande Sertão: Veredas", "O Tigre Branco", "A Sombra do Vento",
            "O Iluminado", "O Soldado Desconhecido", "O Menino do Pijama Listrado", "A Catedral do Mar",
            "O Livro Perdido das Bruxas de Salem", "O Ladrão de Chocolate", "O Código dos Cavaleiros",
            "O Gigante Enterrado", "A História de Edgar Sawtelle", "O Cisne Negro", "O Livro do Cemitério",
            "O Despertar do Príncipe", "O Mar e a Eternidade", "O Oceano no Fim do Caminho", "O Livro dos Espelhos",
            "A Rainha Vermelha", "Os Heróis do Olimpo", "O Livro Secreto de Merlin", "O Feitiço do Tempo",
            "O Código das Sombras", "A Canção do Súcubo", "O Espião", "O Circo do Dr. Lao", "O Cavaleiro do Dragão",
            "A República", "O Amor nos Tempos do Cólera", "A Pedra Filosofal", "A Maldição do Tigre",
            "O Castelo de Vidro", "A Montanha dos Sete Abismos", "O Tesouro de Rackham", "A Fortaleza",
            "O Dono do Morro", "O Médico e o Monstro", "As Mil e Uma Noites", "O Homem Invisível", "O Encontro no Rio",
            "O Caminho do Guerreiro", "A Muralha", "O Poder do Hábito", "A Viagem ao Centro da Terra",
            "O Escândalo da Cidade", "O Peregrino", "O Caçador de Dragões", "A Rosa do Povo", "Os Lusíadas",
            "O Livro da Selva", "A Mulher Desiludida", "A Espada e a Flor", "O Nome do Vento", "O Principezinho",
            "O Diário de Anne Frank", "A Grande Caçada", "O Último dos Dinossauros", "A Ilha da Magia",
            "A Noite dos Tempos", "O Vermelho e o Negro", "A Última Música", "O Outro Lado do Espelho",
            "A Estrada Real", "A Morte em Veneza", "O Livro das Sombras", "O Livro de Jó", "O Código de Da Vinci",
            "A Fortaleza do Dragão", "O Caminho para a Liberdade", "O Pequeno Príncipe", "O Espelho do Tempo",
            "O Livro do Desassossego", "A Cidade Perdida", "O Legado dos Deuses", "A Luz das Trevas",
            "A Primeira Guerra Mundial", "O Livro dos Encantos", "A Grande Recessão", "A Senhora dos Magos",
            "O Enigma da Máquina", "A Chama do Saber", "O Exorcista", "O Jogo das Sombras"
        };
